...
import com.example.restaurants.Model.GPSTracker;
...
//        mSaved_Posts_Button = rootView.findViewById(R.id.home_saved);
        ...
        // current location
       // TextView textViewCountry=rootView.findViewById(R.id.tv_country);
        ...
        if(gps.canGetLocation()){
            ...
            countryName=getCountryName(this.getContext(),gps.getLatitude(),gps.getLongitude());

        }else{
            gps.showSettingsAlert();
        }

        textView=rootView.findViewById(R.id.tv_country);
        textView.setText(countryName);

        mRecentSearch.add(textView);
